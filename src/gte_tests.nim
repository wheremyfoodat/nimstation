...
const TESTS*: seq[Test] = @[
    ...
    Test(desc: "GTE_RTPS, lm=0, cv=0, v=0, mx=0, sf=1",
        reset_controls: @[
            (0, 0x00000ffb'u32),
            (1, 0xffb7ff44'u32),
            (2, 0xf9ca0ebc'u32),
    ...
    Test(desc: "GTE_RTPS, lm=0, cv=0, v=0, mx=0, sf=1 full 0xffffffff",
        reset_controls: @[
            (0, 0xffffffff'u32),
            (1, 0xffffffff'u32),
            (2, 0xffffffff'u32),
    ...
    Test(desc: "GTE_OP GTE_RTPS, lm=0, cv=0, v=0, mx=0, sf=1 random",
        reset_controls: @[
            (0, 0xff35cdf4'u32),
            (1, 0xf8acd6a6'u32),
            (2, 0x1954aa70'u32),
    ...
    Test(desc: "GTE_MVMVA, lm=0, cv=0, v=0, mx=0, sf=1 full 0xffffffff",
        reset_controls: @[
            (0, 0xffffffff'u32),
            (1, 0xffffffff'u32),
            (2, 0xffffffff'u32),
    ...
    Test(desc: "GTE_MVMVA, lm=0, cv=3, v=3, mx=0, sf=1 full 0xffffffff",
        reset_controls: @[
            (0, 0xffffffff'u32),
            (1, 0xffffffff'u32),
            (2, 0xffffffff'u32),
    ...
    Test(desc: "GTE_OP GTE_MVMVA, lm=0, cv=0, v=0, mx=0, sf=1 random",
        reset_controls: @[
            (0, 0xff35cdf4'u32),
            (1, 0xf8acd6a6'u32),
            (2, 0x1954aa70'u32),
    ...
    Test(desc: "GTE_NCCT, lm=0, cv=0, v=0, mx=0, sf=1",
        reset_controls: @[
            (0, 0x00000ffb'u32),
            (1, 0xffb7ff44'u32),
            (2, 0xf9ca0ebc'u32),
    ...
    Test(desc: "GTE_NCCT, lm=0, cv=0, v=0, mx=0, sf=1 full 0xffffffff",
        reset_controls: @[
            (0, 0xffffffff'u32),
            (1, 0xffffffff'u32),
            (2, 0xffffffff'u32),
